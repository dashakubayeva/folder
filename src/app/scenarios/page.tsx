      ...
      {scenarios.length === 0 ? (
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/scenarios/new"
              className="flex items-center gap-1.5 bg-violet-600 hover:bg-violet-700 text-white px-3.5 py-1.5 rounded-lg text-sm font-medium transition-colors"
            >
            ...
            {scenarios.map((s) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <Link href={`/scenarios/${s.id}/results`} className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors">
                    Results
                  </Link>
                  <Link href={`/scenarios/${s.id}`} className="bg-violet-50 hover:bg-violet-100 text-violet-700 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors">
                    Edit
                  </Link>
                  <button
