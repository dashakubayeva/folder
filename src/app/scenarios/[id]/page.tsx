...
export default async function EditScenarioPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <Link href="/scenarios" className="inline-flex items-center gap-1 text-sm text-violet-600 hover:text-violet-800 transition-colors mb-2">
        ...
        <p className="text-sm text-slate-500 mt-0.5">Edit scenario</p>
      </div>
